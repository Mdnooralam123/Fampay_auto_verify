...
QR generated client-side for reliability.
"""
...
def qr_image():
    # Keep for backward compatibility, but payment page now uses client-side QR
    try:
        order_id = request.args.get('order_id')
        if not order_id:
...
# ============================================
# KHAN PAY PAYMENT HTML – Client-side QR generation
# ============================================
PAYMENT_HTML = '''
<!doctype html>
<html lang="en">
